...
private fun ContentView(navController: NavController){
    Column(
        ...
        SubTitleView("  En una sartén, calienta el aceite y fríe ½ cebolla hasta que cambie de color. Agrega el ajo, la carne, el Jugo MAGGI®, la Salsa Tipo Inglesa CROSSE & BLACKWELL®, 2 chiles, la sal con ajo y el perejil; cocina por 3 minutos.")
        Text(text = "  2.Rellena", fontSize = 30.sp, color = Color.White)
        SubTitleView("  Rellena las tortillas con la preparación de carne, añade frijoles y queso, doblas las orillas y enrolla. Ásalos en una sartén por ambos lados y corta a la mitad.")
        Text(text = "  3.Sirve", fontSize = 30.sp, color = Color.White)
        SubTitleView("  Para el pico de gallo, mezcla ½ cebolla con los jitomates, 1 chile serrano, el cilantro, el aguacate, el jugo de limón, la sal con cebolla y acompaña con los burritos. Ofrece.")
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(10.dp),
